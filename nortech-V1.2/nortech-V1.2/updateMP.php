...
?>
        ...
        <fieldset class="col-md-6 align-self-center f1">
                ...
                <form class="border border-success p-5" method="POST" name="apdate_user" action="traitement.php?action=update1&section=user&id=<?php echo $ide;?>" required>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <label for="mp_user" >Nouveau MotPasse:</label>
                <input type="text" id="text"  class="form-control mb-1" placeholder="" name="mp" required >

                <label for="mpc_user" >Confirmer MotPasse:</label>
                <input type="text" id="text"  class="form-control mb-1" placeholder="" name="mpc" required >
            </div>
