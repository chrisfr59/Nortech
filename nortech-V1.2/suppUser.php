...
?>
        ...
        <fieldset class="col-md-6 align-self-center f1">
                ...
                <form class="border border-success p-5" method="POST" name="supp_user" action="traitement.php?action=supprimer&section=user&id=<?php echo $id;?>" required>
                    <div class="row">
                        <div class="col-md-6">
                <label for="id_user">id Utilisateur:</label>
                <input type="text" id="textInput" class="form-control mb-20"  placeholder="" name="id_user" required value="<?php echo $result['identifiant'];?>" disabled>
            </div>
                <input class="btn btn-danger btn-block my-4" type="submit" value="Supprimer" >
