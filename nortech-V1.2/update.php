...
<?php
    ...
    <form name="offre" method="post" action="traitement.php?section=offre&action=update&id=<?php echo $id;?>">
        ...
        <div class=''>
            ...
            <input type="number" name="noannonce" id="noannonce" value="<?php echo $resultat['noAnnonce'];?>" readonly />
        </div><br>
        ...
        <select name="serv" id="noserv" >
                    <option value="">--Choisire le service--</option>
