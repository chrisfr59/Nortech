...
<div class="container-fluid">
        <div class="row">
            ...
            <fieldset>
                ...
                <!--Fonction pour rechercher un employé/recharger les absences persos et retourner des informations-->
                <form class="search_bar" role="search" method="get" action="">
                    ...
                    <input class="search-submit" value="Rechercher" type="submit" name="submit"/><br /><br />
                    <input type="submit" class="search-submit" value="Revenir à mes congés" name="retour" href="absence.php">
                </form>
                ...
                function rechercher($noEmp){
                    ...
                    $reponse=$req->execute(array());
                        ...
                        $sql='SELECT e.noEmp, e.nom, e.prenom, a.types, DATE_FORMAT(a.dateAbsD,"%d-%m-%Y"), DATE_FORMAT(a.dateAbsF,"%d-%m-%Y"), a.motif FROM nortech.absence a, nortech.employe e, nortech.utilisateur u WHERE a.noEmp=e.noEmp AND e.identifiant=u.identifiant AND u.identifiant like "'.$_SESSION['pseudo'].'" ORDER BY a.dateAbsD DESC';
                ...
                <p>Jours de congés pris :
                    ...
                    //Calculer le nombre de jours pris par rapport au formulaire de la personne loggée
                        ...
                        $sql='SELECT SUM(a.nbJPris) as nombre FROM nortech.employe e, nortech.absence a, nortech.utilisateur u WHERE a.noEmp=e.noEmp AND e.identifiant=u.identifiant AND u.identifiant like "'.$_SESSION['pseudo'].'"';
                        $req2=$connexion->prepare($sql);
                        $reponse2=$req2->execute(array());
                        $test=0;
                        while($resultat2=$req2->fetch()){
